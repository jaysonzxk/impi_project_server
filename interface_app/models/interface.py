...
class Interface(models.Model, Base):
    ...
    url = models.CharField('url', blank=True, max_length=500)
    ...
    service = models.ForeignKey(Service, blank=False, related_name='service_interface', on_delete=models.SET_DEFAULT, default=0)
